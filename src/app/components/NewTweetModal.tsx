            ...
            <div>
              <div className="mb-4">
                ...
                <textarea
                  ...
                  className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm leading-relaxed resize-none focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-300 transition-all placeholder-gray-400"
                  dir="rtl"
                />
              </div>
            </div>
